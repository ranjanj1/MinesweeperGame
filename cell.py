...
class Cell:
    ...
    def left_click_action(self,event):
        if self.is_mine:
            ...
            # if mines count is equal to left count then win
            if Cell.cell_count == settings.MINES_COUNT:
                messagebox("Congratulations! You won the game!!") 

        # cancel left and right click events if cell is alredy open
    ...
    def show_mine(self):
        ...
        messagebox.showinfo("Title", "OOPS..It's Mine. Game Over!") 
        sys.exit()
